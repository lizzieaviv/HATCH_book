---
title: "12PP HATCH Qualtrics Data: Demographics Cleaning"
...
## Load Data
```{r load-data}
df <- read_sav(here("data/qualtrics/3_renamed", "12pp_renamed.sav")) %>%
...
df.6pp <- read_sav(here("data/qualtrics/4_demographics", "6pp_demo.sav")) %>%
...
```{r}
inspect_labels(df, CoupleID:ASQ12_c1.12pp)
```

## Print
```{r}
print_slice(df, CoupleID:ASQ12_c1.12pp)
```

## Write CSV Files
```{r}
write_sav(df, here("data/qualtrics/4_demographics", "12pp_demo.sav"))
```
